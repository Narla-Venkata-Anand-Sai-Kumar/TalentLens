  ...
  if (showInstructions) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800 flex items-center justify-center p-4">
        <Card className="max-w-4xl mx-auto p-10 shadow-2xl border-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm">
          {/* Header Section */}
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center space-x-4 text-lg text-gray-600 dark:text-gray-300">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            ...
            {/* Interview Format */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-700 rounded-xl p-6 shadow-sm">
              <div className="flex items-center mb-4">
